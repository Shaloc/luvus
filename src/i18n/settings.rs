...
pub static EN: Catalog = Catalog {
    ...
    remote_hosts: "Remote",
    remote_hosts_hint: "Select to connect and discover sessions. Deselect to disconnect. u: update the selected host from fork releases.",
...
pub static ES: Catalog = Catalog {
    ...
    remote_hosts_hint: "Selecciona para conectar y descubrir sesiones. Desmarca para desconectar. u: actualizar el host seleccionado desde versiones del fork.",
...
pub static PT: Catalog = Catalog {
    ...
    remote_hosts: "Remotos",
    remote_hosts_hint: "Selecione para conectar e descobrir sessões. Desmarque para desconectar. u: atualizar o host selecionado pelas versões do fork.",
...
pub static FR: Catalog = Catalog {
    ...
    remote_hosts_hint: "Cochez pour connecter et découvrir les sessions. Décochez pour déconnecter. u : mettre à jour l’hôte sélectionné depuis les versions du fork.",
...
pub static DE: Catalog = Catalog {
    ...
    remote_hosts: "Remote",
    remote_hosts_hint: "Auswählen verbindet und findet Sitzungen. Abwählen trennt die Verbindung. u: ausgewählten Host aus Fork-Releases aktualisieren.",
...
pub static ID: Catalog = Catalog {
    ...
    remote_hosts: "Remote",
    remote_hosts_hint: "Pilih untuk menghubungkan dan menemukan sesi. Hapus pilihan untuk memutuskan. u: perbarui host terpilih dari rilis fork.",
...
pub static ZH: Catalog = Catalog {
    ...
    remote_hosts: "远端",
    remote_hosts_hint:
        "勾选即连接并发现会话；取消勾选即断开连接。 u：从 fork release 更新当前已勾选的主机。",
...
pub static JA: Catalog = Catalog {
    ...
    remote_hosts: "リモート",
    remote_hosts_hint: "選択すると接続してセッションを検出します。解除すると切断します。 u：選択したホストをフォークのリリースから更新。",
...
pub static KO: Catalog = Catalog {
    ...
    remote_hosts: "원격",
    remote_hosts_hint: "선택하면 연결하고 세션을 검색합니다. 선택 해제하면 연결을 끊습니다. u: 선택한 호스트를 fork 릴리스로 업데이트.",
