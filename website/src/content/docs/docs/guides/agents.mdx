...
Kimi, Qoder CLI, Grok, Hermes CLI, Muse Code, Pi, Oh My Pi (OMP), Cursor, Gemini, Qwen,
...
Aider, Kilo Code, Qoder CLI, Kiro, Cursor, Amp, Droid, Muse, and manifest-defined agents still receive live
...
```sh
luvus integration install claude    # or: copilot · codex · antigravity · opencode · kimi · qodercli · grok · hermes · omp
```
