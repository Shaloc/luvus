...
Kimi, Qoder CLI, Grok, Hermes CLI, Letta Code, Muse Code, Pi, Oh My Pi (OMP),
...
Aider, OpenCode V2, Kilo Code, Kiro, Qoder CLI, Cursor, Amp, Droid, Muse, Devin, Letta Code, and
