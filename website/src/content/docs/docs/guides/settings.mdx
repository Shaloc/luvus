...
| **Remote** | selected SSH hosts, global same-name merge, and **Auto-install Luvus when selecting a host** (off by default) |
...
It installs a missing/incompatible fork binary on macOS ARM64 or Linux x86_64,
