...
printf '%s\n' "$version"
case "$version" in
  "luvus "*" remote-session=2 transport=9"|"luvus "*" remote-session=2 transport=10"|"luvus "*" remote-session=2 transport=11"|"luvus "*" remote-session=2 transport=12"|"luvus "*" remote-session=2 transport=13") ;;
